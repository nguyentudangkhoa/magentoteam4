<?php
namespace BestSeller\Seller\Block\Widget;

class Bestsellerproduct extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    protected $_template = 'widget/bestsellerwidget.phtml';
    ...
    public function getOriginalPrice($id){
        ...
        $productCollection = $objectManager->create('Magento\Catalog\Model\Product')->load($id);
